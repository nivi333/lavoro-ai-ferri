...
export function InventoryTable({
  ...
  return (
    <DataTable sortColumn={sortColumn} sortDirection={sortDirection} onSort={onSort}>
      <TableHeader>
        <TableRow>
          <TableHead className='w-[100px]' sortable sortKey='productCode'>
            Code
          </TableHead>
          <TableHead sortable sortKey='productName'>
            Product
          </TableHead>
          ...
          <TableHead className='text-right' sortable sortKey='reservedQuantity'>
            Reserved
          </TableHead>
          <TableHead className='text-right' sortable sortKey='availableQuantity'>
            Available
          </TableHead>
