...
const createInspectionSchema = Joi.object({
  ...
  inspectorName: Joi.string().optional().allow('', null),
  ...
  nextInspectionDate: Joi.date().optional().allow(null),
  inspectorNotes: Joi.string().max(1000).optional().allow('', null),
  recommendations: Joi.string().max(1000).optional().allow('', null),
  status: Joi.string().valid('PENDING', 'IN_PROGRESS', 'PASSED', 'FAILED', 'CONDITIONAL').optional().allow(null),
  qualityScore: Joi.number().min(0).max(100).optional().allow(null),
...
const updateInspectionSchema = Joi.object({
  ...
  overallResult: Joi.string().valid('PASS', 'FAIL', 'CONDITIONAL').optional().allow(null),
  qualityScore: Joi.number().min(0).max(100).optional().allow(null),
  inspectorNotes: Joi.string().max(1000).optional().allow('', null),
  recommendations: Joi.string().max(1000).optional().allow('', null),
  inspectorName: Joi.string().optional().allow('', null),
...
const createTemplateSchema = Joi.object({
  ...
  passingScore: Joi.number().min(0).max(100).optional().allow(null),
