...
import { SearchOutlined, FileTextOutlined, SaveOutlined, DollarOutlined } from '@ant-design/icons';
...
const StockValuationReportPage: React.FC = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      const data = await reportService.getStockValuationReport(locId);
      setReportData(data);
    } catch (error) {
  ...
  const columns = [
    {
      ...
      dataIndex: 'product',
      key: 'product',
      sorter: (a: StockValuationData, b: StockValuationData) => a.product.localeCompare(b.product),
      filteredValue: searchText ? [searchText] : null,
      onFilter: (value: any, record: StockValuationData) =>
    ...
    },
    {
      ...
      dataIndex: 'quantity',
      key: 'quantity',
      sorter: (a: StockValuationData, b: StockValuationData) => a.quantity - b.quantity,
    },
    {
      title: 'Cost Price',
      dataIndex: 'costPrice',
    ...
    },
    {
      ...
      dataIndex: 'costValue',
      key: 'costValue',
      sorter: (a: StockValuationData, b: StockValuationData) => a.costValue - b.costValue,
      render: (value: number) => `₹${value.toFixed(2)}`,
    },
    {
      title: 'Retail Value',
      ...
      key: 'retailValue',
      sorter: (a: StockValuationData, b: StockValuationData) => a.retailValue - b.retailValue,
      render: (value: number) => `₹${value.toFixed(2)}`,
    },
    {
      ...
      key: 'potentialProfit',
      sorter: (a: StockValuationData, b: StockValuationData) =>
    ...
    <MainLayout>
      <div className='page-container'>
        <div className='page-header-section'>
          ...
          />
          <Title level={2}>Stock Valuation Report</Title>
        </div>
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col xs={24} sm={12} md={6}>
                <Card className='summary-card'>
                  ...
                  <div className='summary-value' style={{ color: '#1890ff' }}>
...
export default StockValuationReportPage;
