...
const AccountsPayableReportPage: React.FC = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      const data = await reportService.getAPAgingReport(dateStr);
      setReportData(data);
    } catch (error) {
  ...
  const getTableData = () => {
    ...
    return reportData.suppliers.map((item: any, index: number) => ({
      key: `supplier-${index}`,
    ...
    <MainLayout>
      <div className='page-container'>
        <div className='page-header-section'>
          ...
          />
          <Title level={2}>Accounts Payable Aging</Title>
        </div>
              ...
              <Col xs={24} sm={12} md={6} lg={4}>
                <Card className='summary-card'>
                  ...
                  <div className='summary-value'>
                    ₹{reportData.summary?.totalPayables?.toFixed(2) || '0.00'}
                  </div>
                </Card>
              </Col>
              <Col xs={24} sm={12} md={6} lg={4}>
          ...
          <div className='report-data'>
            {loading ? (
              ...
              <div className='empty-report'>
                <p>Select a date and click "Generate Report" to view Accounts Payable Aging.</p>
              </div>
            )}
          </div>
        </div>
